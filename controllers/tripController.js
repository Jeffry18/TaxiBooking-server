...
exports.getTrips = async (req, res) => {
  try {
    const trips = await Trip.find().populate('packageId', 'name description duration price image');
    res.json({
      success: true,
      data: trips
    });
...
exports.getTripById = async (req, res) => {
  try {
    const trip = await Trip.findById(req.params.id).populate('packageId', 'name description duration price image');
...
exports.getTripsByStatus = async (req, res) => {
  try {
    ...
    const trips = await Trip.find({ status }).populate('packageId', 'name description duration price image');
